			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<!--头像 -->
						<form id="am-form am-form-horizontal" action="/home/informat"    method="post"  enctype="multipart/form-data">
							{{ csrf_field() }}
<!-- 							{{ method_field('PUT') }}	 -->	
							...
							<div class="filePic">
								...
								<img class="am-circle am-img-thumbnail" id="image" src="/home/images/getAvatar.do.jpg" alt="我的头像" />
						...
						<div class="info-main">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" name="user_name"  placeholder="nickname">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" placeholder="telephone" name="telephone" type="tel">
