					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/home/images/01.jpg"><img src="{{$images[0]['img']}}" alt="细节展示放大镜特效" rel="{{$images[0]['img']}}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								@foreach($images as $k=>$v)
								<li @if($k==0) class="tb-selected" @endif>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="{{$v->img}}" mid="{{$v->img}}" big="{{$v->img}}"></a>
									</div>
								</li>
								@endforeach
							</ul>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">{{0.8*$products[0]['price']}}</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">{{$products[0]['price']}}</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								...
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count sales">{{$products[0]['sales']}}</span></div>
								</li>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
                                                    @foreach($propertie_data as $pk=>$pv)
													<div class="theme-options">
														<div class="cart-title sku">{{$pk}}</div>
														<ul>	 
															@foreach($pv as $pkk=>$pvv)
															<li   class="sku-line @if($sp[$pk]==$pvv) selected @endif"  >{{$pvv}}<i></i></li>
															@endforeach
														</ul>
													</div>
													@endforeach
													<div class="theme-options">
														...
														<dd>
															...
															<span id="Stock" class="tb-hidden">库存<span class="stock">{{$products[0]['stock']}}</span>件</span>
														</dd>
...
function change_price(){
	//theme-options
	 var a=$('.sku');
     var s=$('.sku-line.selected');
     var arr=[];
	 a.each(function(k,v){
        arr[k]=$(v).text()+':'+s.eq(k).text();
	 });
	 console.log(arr.join(','));
	 var spec=arr.join(',');
	 @foreach($products as $k=>$v)   
      //alert('{{$v->product_spec}}');
      if(spec=='{{$v->product_spec}}'){
		  //alert({{$v->id}});
		  //取得对应规格商品id
		  $.get('/home/index/change_product/{{$v->id}}',function(data){
              //alert(data.id);
			  $('.sys_item_price').text(Math.floor(0.8*data.price)); //Math.floor(15.7784514000 * 100)
			  $('.sys_item_mktprice').text(data.price);
