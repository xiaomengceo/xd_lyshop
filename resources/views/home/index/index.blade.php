										...
										<ul class="category-list" id="js_climit_li">
											...
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/cake.png"></i><a class="ml-22" title="{{$v->title}}">{{$v->title}}</a></h3>
													<em>&gt;</em></div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
							   @foreach($v['sub'] as $s=>$sv)
							    @foreach($sv['sub'] as $ss=>$ssvv)
								<a class="outer" href="#"><span class="inner"><b class="text"> {{$ssvv->title}}</b></span></a>
							    @endforeach
							   @endforeach							
							</div>
							<a href="# ">
							...
							@foreach($goods as $g=>$gv)
							 @if($v->id==$g)
							 @foreach($gv as $gg=>$ggvv)
							    @foreach($ggvv as $ggg=>$gggvvv)
								<div style="float:left;" class="am-u-sm-3 am-u-md-1 text-two  ">
									<div class="outer-con ">
										<div class="title ">
											{{$gggvvv->title}}
										</div>									
									...
									<a href="/home/index/{{$gggvvv->id}} "><img src="{{$gggvvv->gpic}}" /></a>
								</div>
								@endforeach
							 @endforeach
							 @endif	
