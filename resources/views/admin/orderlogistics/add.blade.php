...
<body>
	<center><h3>添加订单物流详细信息</h3></center>
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="logistics_name" name="logistics_name">
		</div>
	</div>
	...
	<!-- <div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" >
			<input type="text" class="input-text" value="" placeholder="" id="order_code" name="order_code">
		</div>
	</div> -->
