...
@endif
    <form class="form form-horizontal" action="/admin/login/check_login" method="post">
       {{ csrf_field() }}
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="code" class="input-text size-L" type="text" placeholder="验证码"   onclick="if(this.value=='验证码:'){this.value='';}" value="" style="width:150px;">
          <img onclick="this.src='/captcha/flat?'+Math.random()" src="{{ captcha_src('flat') }}" title="看不清，点击图片换一张">  </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
