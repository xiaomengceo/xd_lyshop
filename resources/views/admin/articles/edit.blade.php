...
<body>
	<center><h3 style="color:green">编辑文章信息</h3></center>
<article class="page-container">
	<form action="/admin/articleInfos/{{ $data->id }}" class="form form-horizontal" id="form-article-add" method="post">
			{{ csrf_field() }}
				{{ method_field('PUT') }}
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>推荐广告位：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="recommend" class="select">
					<option value="0 ">已推荐</option>
					<option value="1">未推进</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{ $data->auth }}" placeholder="" id="auth" name="auth">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<select name="allow" class="select">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script name="content" id="editor" content type="text/plain" style="width:100%;height:400px;">{{ $data->content }}</script> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input type="submit" value="修改文章详情" class="btn btn-primary radius" >	
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			...
			$(form).ajaxSubmit({
				type: 'post',
				url: "/admin/articleInfos/{{ $data->id }}" ,
