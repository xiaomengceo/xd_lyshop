...
<center><h3>添加文章评论</h3></center>
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="/admin/article_rat" method="post">
	{{ csrf_field()}}
	...
	<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input onClick="article_save_submit();" class="btn btn-primary radius" value="保存并提交审核" type="submit">
