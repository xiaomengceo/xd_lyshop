...
<script type="text/javascript" src="lib/respond.min.js"></script>/admin
<![endif]-->
...
<body>
	...
	<center><h3 style="color:green">添加轮播图片</h3></center>
	 <center><img src="" id="img-thumbnail" style="width:80px;height:80px"></center>
<article class="page-container">
	<form class="form form-horizontal" action="/admin/view_pagers" id="form-admin-add"   method="post"  enctype="multipart/form-data">
		{{ csrf_field() }}
	<div class="row cl">
