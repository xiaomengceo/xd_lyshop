...
<title>更新文章分类 - 分类管理 - H-ui.admin v3.1</title>
<meta name="keywords" content="H-ui.admin v3.1,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="H-ui.admin v3.1，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
	<center><font style="font-size: 25px;color:green">修改分类</font></center>
<article class="page-container">
	<form  action="/admin/article_types/{{ $data->id }}" method="post" class="form form-horizontal"  >
		{{ csrf_field() }}
		{{ method_field('PUT') }}
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{ $data->cate_title }}" placeholder="" id="cate_title" name="cate_title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{ $data->cate_keywords }}" placeholder="" id="cate_keywords" name="cate_keywords">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" type="text/plain" name="cate_descr" style="width:100%;height:400px;">{!! $data->cate_descr!!}</script> 
			</div>
		</div>
		<div class="row cl">
